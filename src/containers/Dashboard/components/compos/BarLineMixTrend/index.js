...
// import { formatRound } from '../../../../../utils/common';
// import {
//   XAXIS,
//   ROTATE,
//   LABEL,
...
//             // 需要去除小數點（進位方式：四捨五入)
//             return data[`${name}`].map((item) => round(item));
//           }
...
//   useEffect(() => {
//     const formatInterval = () => (xAxisType !== XAXIS.type.hiddenOverlap
//       ? XAXIS.interval.default
//       : XAXIS.interval.hiddenOverlap);
//     const formatRotate = () => {
//       if (xAxisType !== XAXIS.type.rotate) {
//         return ROTATE.no;
//       }
//       return xAxisStyle.rotate;
//     };
//     setXAxisOption({
//       interval: formatInterval(),
//       rotate: formatRotate(),
//     });
//   }, [xAxisType, xAxisStyle.rotate]);

//   return <ReactECharts option={options} />;
// }

// BarLineMixTrend.propTypes = {
//   title: PropTypes.string,
//   color: PropTypes.array,
//   lineList: PropTypes.array,
//   dataFormatType: PropTypes.string,
//   isStack: PropTypes.bool,
//   data: PropTypes.object.isRequired,

//   isLegenedLineBreak: PropTypes.bool,
//   legendSliceNumber: PropTypes.number,

//   lineStyle: PropTypes.shape({
//     dottedList: PropTypes.array,
//     dashedList: PropTypes.array,
//   }),

//   xAxisData: PropTypes.array,
//   xAxisType: PropTypes.string,
//   xAxisStyle: PropTypes.shape({
...
//   }),
//   isClickXAxis: PropTypes.bool,

//   yAxisType: PropTypes.string,
//   yAxisStyle: PropTypes.shape({
//     name: PropTypes.shape({
//       left: PropTypes.string,
//       righ: PropTypes.string,
//     }),
//     formatterType: PropTypes.shape({
//       left: PropTypes.string,
//       righ: PropTypes.string,
//     }),
//   }),
...
//   showLabelStyle: PropTypes.shape({
//     seriesList: PropTypes.array,
//     hasFilter: PropTypes.bool,
//     dataList: PropTypes.array,
//     showFocus: PropTypes.bool,
//   }),
//   labelLayoutStyle: PropTypes.shape({
...
//   dataZoomType: PropTypes.string,
//   dataZoomValueSpan: PropTypes.shape({
//     maxValueSpan: PropTypes.number,
//     minValueSpan: PropTypes.number,
//   }),

//   openModal: PropTypes.func,
// };

// BarLineMixTrend.defaultProps = {
//   title: '',
//   color: COLOR,
//   lineList: ['Rate', 'rate', '%'],
//   isStack: false,
...
//   xAxisData: [],
//   xAxisType: XAXIS.type.rotate,
//   xAxisStyle: {
//     grid: XAXIS.grid.rotate,
//     rotate: ROTATE.sm,
//   },
//   isClickXAxis: false,

//   yAxisType: YAXIS.type.biaxial,
//   yAxisStyle: {
//     name: {
//       left: YAXIS.name.default,
//       righ: YAXIS.name.default,
//     },
//     formatterType: {
//       left: YAXIS.formatterType.default,
//       right: YAXIS.formatterType.percent,
//     },
//   },

//   showLabel: LABEL.showLabel.line,
//   showLabelStyle: {
//     seriesList: ['線圖名稱'],
//     hasFilter: false,
//     dataList: [],
...
//   dataZoomType: DATAZOOM.type.partial,
//   dataZoomValueSpan: {
//     maxValueSpan: 5,
//     minValueSpan: 5,
//   },
