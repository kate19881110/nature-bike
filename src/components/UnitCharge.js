    ...
    return (
      ...
      >
        ...
        <Descriptions.Item label="專案代號">
          <Input value={item.projectNum} disabled />
        </Descriptions.Item>
        <Descriptions.Item label="項目">
          <Input value={item.projectItem} disabled />
        </Descriptions.Item>
        <Descriptions.Item label="未稅金額">
          <Input type="number" value={getThousand(item.untaxedMoney)} disabled />
        </Descriptions.Item>
        <Descriptions.Item label="營業稅/所得稅">
          <Input type="number" value={getPercent(item.businessTax)} disabled />
        </Descriptions.Item>
